 ...
 */
    ...
    (() => {
        ...
        if (inputMasks.length) {
            ...
            Inputmask({
                mask: "+7(999) 999-9999"
            }).mask(document.querySelectorAll(".tel"));
        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".thumbs-history")) {
                const thumbsHistory = new core(".thumbs-history", {
                    modules: [ Navigation, Thumb, Grid, EffectFade ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 6,
                    spaceBetween: 10,
            ...
            if (window.innerWidth < 768 && document.querySelector(".thanks__slider")) new core(".thanks__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 0,
